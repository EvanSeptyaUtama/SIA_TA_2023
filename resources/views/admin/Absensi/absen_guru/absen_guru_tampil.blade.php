                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class=""><span class="text-secondary">Tanggal Absen</span> <h4><strong>{{$data_absen_guru->tanggal_absen_guru}}</strong></h4></div>
                                            <div class=""><span class="text-secondary">Waktu Mulai</span> <h4><strong>{{$data_absen_guru->waktu_mulai_guru}}</strong></h4></div>
                                            <div class=""><span class="text-secondary">Waktu Selesai</span> <h4><strong>{{$data_absen_guru->waktu_selesai_guru}}</strong></h4></div>
                                        </div>
                                        <div class="col">
                                            <div class=""><span class="text-secondary">Nama Pengajar</span> <h4><strong>{{$data_absen_guru->pengajar->nama_pengajar}}</strong></h4></div>
