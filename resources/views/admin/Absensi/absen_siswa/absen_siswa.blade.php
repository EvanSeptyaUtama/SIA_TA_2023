            ...
            <div class="card border-dark">
              <div class="row m-2">
                <div class="col-md-12">
                  ...
                  <form action="{{ route('store_absen_siswa') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      @if (count($errors) > 0)
                      <div class="alert alert-danger">
                    ...
                    <div class="card border-dark border-2">
                      <div class="row m-2">
                        ...
                        <div class="col-md-2 mt-1">
                            <a href="{{route('laporan_harian_absen_siswa_kelas_1')}}" class="btn btn-outline-dark"><strong>Kelas 1</strong></a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{route('laporan_harian_absen_siswa_kelas_2')}}" class="btn btn-outline-dark"><strong>Kelas 2</strong></a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{route('laporan_harian_absen_siswa_kelas_3')}}" class="btn btn-outline-dark"><strong>Kelas 3</strong></a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{route('laporan_harian_absen_siswa_kelas_4')}}" class="btn btn-outline-dark"><strong>Kelas 4</strong></a>
                        </div>
                      </div>
                    </div>
                  </div>
