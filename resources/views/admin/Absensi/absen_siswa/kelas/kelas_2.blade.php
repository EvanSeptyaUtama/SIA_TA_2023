    ...
    <div class="m-2">
            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('laporan_harian_absen_siswa_kelas_2')}}">Absen Siswa</a></li>
        ...
        <div class="row justify-content-start mb-1"> 
            <div>
                ...
                <a class="btn btn-success" href="{{route('eksport_excel_kelas_2')}}"> Excel</a>
            </div>
        </div>
        <!----Table---->
        <div class="row">
