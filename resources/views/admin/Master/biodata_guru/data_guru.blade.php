                                ...
                                <td class="text-center">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <form onsubmit="return confirm('Apakah anda yakin edit data guru ?');" action="{{route('edit_guru', $data->id)}}" method="get">
                                            ...
                                            <div class="col">
                                                <form onsubmit="return confirm('Apakah anda yakin hapus data guru ?');" action="{{route('hapus_guru', $data->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
