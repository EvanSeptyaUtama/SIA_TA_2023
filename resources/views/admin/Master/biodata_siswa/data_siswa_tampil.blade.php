        ...
        <div class="container">
            ...
            <!---Table--->
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Profil Siswa') }}</strong></h3></div>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-8"><h5>{{$data_siswa->nama_siswa}}</h5></div> 
                                        
                                        <hr>
                                            <div class="col-md-4 text-secondary">Alamat</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->alamat_siswa}}</h5></div> 
                                        
                                        <hr>
                                            <div class="col-md-4 text-secondary">Jenis Kelamin</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->jenis_kelamin}}</h5></div> 
                                        <hr>
                                            <div class="col-md-4 text-secondary">Tempat Lahir</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->tempat_lahir}}</h5></div> 
                                        <hr>
                                            <div class="col-md-4 text-secondary">Tanggal Lahir</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->ttl}}</h5></div> 
                                        <hr>
                                            <div class="col-md-4 text-secondary">Agama</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->agama}}</h5></div> 
                                        <hr>
                                            <div class="col-md-4 text-secondary">Kelas</div>
                                            <div class="col-md-8"><h5>{{$data_siswa->kelas->nama_kelas}}</h5></div> 
                                        </div>
                                    ...
                                    <div class="col-md-8 pt-2 text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><h5>{{$data_siswa->nisn}}</h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">Tinggal Bersama</div>
                                            <div class="col-md-7"><h5>{{$data_siswa->tinggal_bersama}}</h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">RT/RW</div>
                                            <div class="col-md-7"><h5>{{$data_siswa->rt_rw}}</h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">Desa/Kelurahan</div>
                                            <div class="col-md-7"><h5>{{$data_siswa->desa_kelurahan}}</h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">Kecamatan</div>
                                            <div class="col-md-7"><h5>{{$data_siswa->kecamatan}}</h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">Kode Pos</div>
                                            <div class="col-md-7"><h5>{{$data_siswa->kode_pos}}</h5></div> 
                                        <hr>
                                        ...
                                        <hr>
                                            ...
                                            <div class="col-md-7"><h5>{{$data_siswa->hobi}}</h5></div> 
                                    </div>
                                </div>
                            </div>
                        </div>
