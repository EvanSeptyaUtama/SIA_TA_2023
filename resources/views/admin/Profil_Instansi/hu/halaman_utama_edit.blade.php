...
@section('content')
    <div class="m-2">
        ...
        <div class="d-flex justify-content-end mb-2">
            <div>
                <a class="btn btn-warning" href="{{route('index_halaman_utama')}}"> Kembali</a>
            </div>
        </div>
         <!---Alert-->
        ...
        <div class="table-responsive">
            <div class="card">
                <div class="card-header text-center">{{ __('Edit Data Halaman Utama') }}</div>
                
                <div class="card-body">
                    <form action="{{ route('update_halaman_utama', $halaman_utama) }}" method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
