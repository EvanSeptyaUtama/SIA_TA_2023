...
@section('content')
    <div class="m-2">
        ...
        <div class="table-responsive">
            <div class="card">
                <div class="card-header text-center">{{ __('Edit Data Halaman Sejarah') }}</div>
                
                <div class="card-body">
                    <form action="{{route('update_sejarah', $data_sejarah)}}" method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
