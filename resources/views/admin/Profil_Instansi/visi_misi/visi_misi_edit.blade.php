    ...
    <div class="m-2">
        ...
        <div class="row justify-content-center">
            ...
            <div class="table-responsive">
                <div class="card">
                    <div class="card-header text-center">{{ __('Data Halaman Visi-Misi') }}</div>
                    
                    <div class="card-body">
                        <form action="{{route('update_visi_misi', $data_visi_misi)}}" method="post" enctype="multipart/form-data">
                            @method('patch')
                            @csrf
