...
@section('content')
    <div class="m-2">
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <td>
                                    <img src="{{url('storage/PPDB/'. $data->gambar_informasi_pengumuman) }}" class="rounded" alt="" height="150px">
                                 </td>
                                 <td class="text-center">
                                    <div>
                                        <form action="{{route('tampil_halaman_ip_ppdb', $data)}}" method="get">
                                            <button type="submit" class="btn btn-secondary mt-2">
                                                Lihat
                                            </button>
                                        </form>
                                        <form action="{{route('edit_halaman_ip_ppdb', $data)}}" method="get">
                                            <button type="submit" class="btn btn-info mt-2">
                                                Edit
                                            </button>
                                        </form>
                                       <form action="{{route('hapus_halaman_ip_ppdb', $data->id)}}" method="post">
                                            @csrf
                                            @method('delete')
      ...
      @include('admin.ppdb.hal_ip_ppdb_tambah')
    </div>
@endsection