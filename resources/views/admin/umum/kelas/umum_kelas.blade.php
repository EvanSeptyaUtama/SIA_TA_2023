            ...
            <div class="row justify-content-start">
                <div class="col-md-5 p-2">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Data Kelas') }}</strong></h3></div>
                            <div class="card-body">
                                            ...
                                            <td>
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <form action="{{route('edit_kelas',$data)}}" method="get">
                                                        ...
                                                        <div class="col">
                                                            <form action="{{ route('hapus_kelas', $data->id) }}" method="post">
                                                                @csrf
                                                                @method('delete')
                ...
                <div class="col-md-7 pt-2">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Tambah Data Kelas') }}</strong></h3></div>
