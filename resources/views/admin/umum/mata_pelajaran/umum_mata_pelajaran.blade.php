            ...
            <div class="row justify-content-start">
                <div class="col-md-5 p-2">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Data Mata Pelajaran') }}</strong></h3></div>
                                        ...
                                        <tr >
                                            ...
                                            <td >
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col">
                                                            <form action="{{route('edit_mata_pelajaran',$data)}}" method="get">
                                                        ...
                                                        <div class="col">
                                                            <form action="{{ route('hapus_mata_pelajaran', $data->id) }}" method="post">
                                                                @csrf
                                                                @method('delete')
                ...
                <div class="col-md-7 pt-2">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Tambah Data Mata Pelajaran') }}</strong></h3></div>
