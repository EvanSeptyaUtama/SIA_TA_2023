           ...
           <div class="row justify-content-center">
            ...
            <div class="row justify-content-start">
                    ...
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center">
                                <h3><strong>{{ __('Data Tahun Pelajaran') }}</strong></h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr >
                                            ...
                                            <td >
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col">
                                                            <form action="{{route('edit_tahun_pelajaran',$data)}}" method="get">
                                                        ...
                                                        <div class="col">
                                                            <form action="{{ route('hapus_tahun_pelajaran', $data->id) }}" method="post">
                                                                @csrf
                                                                @method('delete')
                ...
                <div class="col-md-7 pt-2">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-header text-center"><h3><strong>{{ __('Tambah Data Tahun Ajaran') }}</strong></h3></div>
