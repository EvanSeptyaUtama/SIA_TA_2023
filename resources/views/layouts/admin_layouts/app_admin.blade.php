                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->role =='admin')
                                        <a class="dropdown-item" href="{{ route('show_profile_admin') }}">
                                            Profile
                                        </a>
                        ...
                        <ul class="nav flex-column">
                            ...
                            <div class="nav-itemku dropdown">
                                <div class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Halaman Awal Website</div>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('index_visi_misi')}}">Visi - Misi</a></li>
                                        <li><a class="dropdown-item" href="{{route('index_susunan_organisasi')}}">Struktur Organisasi</a></li>
                                        <li><a class="dropdown-item" href="{{route('index_informasi_akademik')}}">Informasi Akademik</a></li>
                                    </ul>
                            </div>
                            ...
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{route('index_rekap_absen_guru') }}">Rekab Absensi</a></li>
                                </ul>
                            </div>
                            <!---Menu Coba--->
                            <div class="main_utama">
                            ...
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('index_kategori')}}">Kategori</a></li>
                                <li><a class="dropdown-item" href="{{route('index_produk')}}">Produk</a></li>
                                <li><a class="dropdown-item" href="{{route('index_kota')}}">Kota</a></li>
                                {{-- <li><a class="dropdown-item" href="{{route('index_kehadiran')}}">Kehadiran</a></li> --}}
                                <li><a class="dropdown-item" href="{{route('index_student')}}">Laravel (hindi)</a></li>
                                </ul>
                            </div>
                            {{-- <div class="nav-itemku dropdown">
                                <div class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Query Builder</div>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('index_kategori')}}">Where</a></li>
                                    <li><a class="dropdown-item" href="{{route('index_produk')}}">Where Between</a></li>
                                </ul>
                            </div> --}}
