      ...
      <div class="row feature-icons" >
        ...
        <div class="row">
          <div class="col-xl-4 text-center" >
            <img src="{{url('storage/PPDB/'.$data->gambar_brosur_ppdb)}}" class="img-fluid p-4" alt="">
          </div>
      ...
      <div class="row gy-4 portfolio-container" >
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="{{url('storage/PPDB/'.$data->gambar_informasi_pengumuman)}}" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>{{$data->judul_informasi_pengumuman}}</h4>
              <div class="portfolio-links">
                <a href="{{url('storage/PPDB/'.$data->gambar_informasi_pengumuman)}}" data-gallery="portfolioGallery" class="portfokio-lightbox" title="{{$data->judul_informasi_pengumuman}}">Lihat</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Home</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Sejarah</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Visi-Misi</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Aktivitas</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Organisasi</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Informasi Akademik</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('halaman_utama')}}">Kontak</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-2 col-6 footer-links">
            <h4>PPDB</h4>
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="{{route('index_halaman_web_ppdb')}}">Halaman PPDB</a></li>
            </ul>
          </div>
