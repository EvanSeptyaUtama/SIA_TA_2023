                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-8 pt-2">
                                        ...
                                        <hr>
                                            ...
                                            <div class="col-md-7"><h5><?php echo e($data_siswa->suku); ?></h5></div> 
                                        <hr>
                                            <div class="col-md-5 text-secondary">Jumlah Saudara</div>
                                            <div class="col-md-7"><h5><?php echo e($data_siswa->jumlah_saudara); ?></h5></div> 
                                        <hr>
...
<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Master/data_siswa_tampil.blade.php ENDPATH**/ ?>