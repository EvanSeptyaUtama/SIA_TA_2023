    ...
    <div class="m-2">
        <div class="container-fluid">
            ...
            <div class="row">
                                ...
                                <td class="text-center">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <form onsubmit="return confirm('Apakah anda yakin edit data guru ?');" action="<?php echo e(route('edit_guru', $data->id)); ?>" method="get">
                                            ...
                                            <div class="col">
                                                <form onsubmit="return confirm('Apakah anda yakin hapus data guru ?');" action="<?php echo e(route('hapus_guru', $data->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
             ...
             <!-- Modal -->
             <?php echo $__env->make('admin.Master.biodata_guru.data_guru_tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Master/biodata_guru/data_guru.blade.php ENDPATH**/ ?>