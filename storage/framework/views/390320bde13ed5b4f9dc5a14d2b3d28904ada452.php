                        ...
                        <ul class="nav flex-column">
                            ...
                            <div class="nav-itemku dropdown">
                                <div class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Data Pengguna</div>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo e(route('index_user_admin')); ?>"><i class="fa fa-user-circle-o"></i> Admin</a></li>
                                    </ul>
                            </div>
                             <!---Sidebar : Data Master--->
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('index_guru')); ?>">Guru</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('index_siswa')); ?>"><i class="fa fa-user"></i> Siswa</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('index_pengajar')); ?>"><i class="fa fa-user"></i> Pengajar</a></li>
                                </ul>
                            </div>
                             <!---Sidebar : Data Umum--->
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('index_tahun_pelajaran')); ?>"><i class="fa fa-book"></i> Tahun Pelajaran</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('index_kelas')); ?>"><i class="fa fa-book"></i> Kelas</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('index_mata_pelajaran')); ?>"><i class="fa fa-book"></i> Mata Pelajaran</a></li>
                                </ul>
                            </div>
                            <div class="nav-itemku dropdown">
                                <div class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Jadwal Mengajar</div>
                                <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('tambah_jadwal_mengajar_guru')); ?>"><i class="fa fa-plus-circle"></i> Tambah Jadwal</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('index_jadwal_mengajar_guru')); ?>"><i class="fa fa-calendar-plus-o"></i> Daftar Mengajar</a></li>
                                </ul>
                            </div>
                            <div class="main_utama">
                            ...
                            <div class="nav-itemku dropdown">
                             ...
                             <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('index_halaman_ppdb')); ?>">Halaman Utama PPDB</a></li>
                            ...
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu collapse">
                                    <li><a class="dropdown-item" href="<?php echo e(route('index_absen_siswa')); ?>"><i class="fa fa-user-plus"></i> Absensi</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('index_absen_siswa')); ?>"><i class="fa fa-calendar-check-o"></i> Rekab Absensi</a></li>
                            ...
                            <div class="nav-itemku dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo e(route('index_absen_guru')); ?>"><i class="fa fa-user-plus"></i> Absensi</a></li>
                                </ul>
                            </div>
                            <!---Menu Coba--->
                            <div class="main_utama">
