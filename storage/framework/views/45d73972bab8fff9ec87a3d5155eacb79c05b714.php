            ...
            <div class="row m-2">
                <div class="col-md-12">
                    ...
                    <?php if(!is_null($tanggalFormatted)): ?>
                        <h5>Hasil rekapitulasi absensi guru mulai dari tanggal <?php echo e($tanggalFormatted); ?> : </h5>
                    <?php endif; ?>
                    
                    <form action="<?php echo e(route('index_rekap_absen_guru')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-4">
                            <div class="col-md-5">
...
<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Preinan\sistem_absen\SIA_TA_2023\resources\views/admin/Absensi/absen_guru/rekap_guru.blade.php ENDPATH**/ ?>