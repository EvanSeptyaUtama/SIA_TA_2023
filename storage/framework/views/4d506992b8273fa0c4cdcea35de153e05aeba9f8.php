...
<?php $__env->startSection('title', 'Admin | Aktivitas'); ?>
    ...
    <div class="m-2">
        ...
        <div class="table-responsive">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('update_aktivitas', $data_aktivitas)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo method_field('patch'); ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label>Aktivitas</label>
                            <input type="text" name="nama_aktivitas"class="form-control"
                                value="<?php echo e($data_aktivitas->nama_aktivitas); ?>">
                        </div>
                        <div class="form-group">
                            <label>Penejelasan</label>
                            <input type="text" name="penjelasan_aktivitas"class="form-control"
                            value="<?php echo e($data_aktivitas->penjelasan_aktivitas); ?>">
                        </div>
                        <div class="form-group">
                            <label>Gambar</label>
...
<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Profil_Instansi/aktivitas/aktivitas_edit.blade.php ENDPATH**/ ?>