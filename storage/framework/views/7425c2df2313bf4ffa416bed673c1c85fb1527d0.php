    ...
    <div class="m-2">
            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('laporan_harian_absen_siswa_kelas_2')); ?>">Absen Siswa</a></li>
        ...
        <div class="row justify-content-start mb-1"> 
            <div>
                ...
                <a class="btn btn-success" href="<?php echo e(route('eksport_excel_kelas_2')); ?>"> Excel</a>
            </div>
        </div>
        <!----Table---->
        <div class="row">
                    ...
                    <table id="example" class="table table-striped nowrap" style="width:100%">
                      ...
                      <tbody>
                            <?php $__currentLoopData = $data_absen_siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($data->kelas->nama_kelas == '2'): ?>
                                <tr class="text-center">
...
<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Absensi/absen_siswa/kelas/kelas_2.blade.php ENDPATH**/ ?>