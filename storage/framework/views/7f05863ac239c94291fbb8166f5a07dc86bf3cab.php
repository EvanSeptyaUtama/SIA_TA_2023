                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-md-4">
                            ...
                            <div class="d-flex justify-content-center">
                                            <?php if($data_guru->foto_guru != ''): ?>
                                                <img src="<?php echo e(url('storage/Pengajar/'. $data_guru->foto_guru)); ?>" class="rounded mb-2 w-full h-full" alt="" height="200px">    
                                            <?php else: ?>
                            ...
                            <div class="row pt-2">
                                ...
                                <hr>
                                    ...
                                    <div class="col-md-8"><h5><?php echo e($data_guru->kelas ? $data_guru->kelas->nama_kelas : 'Bukan sebagai wali kelas'); ?></h5></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin_layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Master/biodata_guru/data_guru_tampil.blade.php ENDPATH**/ ?>