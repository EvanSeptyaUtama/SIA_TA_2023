    ...
    <tbody>
        <?php $__currentLoopData = $data_absen_siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($data->kelas->nama_kelas == '2'): ?>  
                <tr class="text-center">    
                    <td>
                        <?php echo e($data->tahun_ajarans->tahun_ajaran); ?>

                    </td>    
                    <td>
                        <?php echo e($data->semesters->nama_semester); ?>
...
</table><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Absensi/absen_siswa/kelas/kelas_2_export_excel.blade.php ENDPATH**/ ?>