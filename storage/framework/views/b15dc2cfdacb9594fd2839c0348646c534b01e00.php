        ...
        <div class="row">
          <?php $__currentLoopData = $data_hal_utama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div  class="col-lg-5 d-flex flex-column justify-content-center">
              ...
              <a type="button" class="btn btn-outline-dark" href="<?php echo e(route('index_halaman_web_ppdb')); ?>"><strong>Pendaftaran Peserta Didik Baru</strong></a>
            </div>
            <div class="col-lg-7 mt-1"  >
              ...
              <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  ...
                  <img src="<?php echo e(url('storage/Halaman_Utama1/'. $data->gambar_pertama)); ?>" class="rounded img-fluid" width="700" height="500"  alt="">
                    <div class="carousel-caption d-none d-md-block">
                      <h5><strong>STAR GENERATION</strong></h5>
                      <p><?php echo e($data->deskripsi_gambar1); ?></p>
                    </div>
                  </div>
                  <div class="carousel-item">
                  <img src="<?php echo e(url('storage/Halaman_Utama2/'. $data->gambar_kedua)); ?>" class="rounded img-fluid" width="700" height="500" alt="">
                    <div class="carousel-caption d-none d-md-block">
                    <h5><strong>STAR GENERATION</strong></h5>
                      <p><?php echo e($data->deskripsi_gambar2); ?></p>
                    </div>
                  </div>
                  <div class="carousel-item">
                  <img src="<?php echo e(url('storage/Halaman_Utama3/'. $data->gambar_ketiga)); ?>" class="rounded img-fluid" width="700" height="500"  alt="">
                    <div class="carousel-caption d-none d-md-block">
                    <h5><strong>STAR GENERATION</strong></h5>
                      <p><?php echo e($data->deskripsi_gambar3); ?></p>
                    </div>
                  </div>
                </div>
