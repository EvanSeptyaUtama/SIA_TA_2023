...
<div class="modal fade" id="dataPengajar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('store_pengajar')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?> 
                <div class="row mb-2">
  ...
  </div><?php /**PATH C:\xampp\htdocs\project-TA\laravel9\sistem_informasi_akademik\resources\views/admin/Master/biodata_pengajar/tambah_pengajar.blade.php ENDPATH**/ ?>